<div x-data="{ open: false }">
    <button @click="open = !open" id="addcontent_block_2" class="w-full h-full px-6 py-2 mx-auto tracking-wide text-darkgreen capitalize transition-colors duration-300 transform bg-[#f8e5e5] hover:bg-[#e06469]">
  
        <div class="grid grid-cols-4 text-[#545454]">
            <div class="">
                <box-icon type='solid' class="border-[#545454]" name='card' size="md"></box-icon>					
            </div>
            <div class="">
                <box-icon type='solid' class="text-[#545454]" name='card' size="md"></box-icon>					
            </div>
            <div class="">
                <box-icon type='solid' class="text-[#545454]" name='card' size="md"></box-icon>					
            </div>
    ...
    <button @click="open = !open" id="opencb2" class="hidden w-full px-6 py-2 mx-auto tracking-wide text-white capitalize transition-colors duration-300 transform bg-red-600 rounded-md hover:bg-red-200 focus:outline-none focus:ring focus:ring-red-300 focus:ring-opacity-80"></button>
            ...
            <div class="relative inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl rtl:text-right dark:bg-gray-900 sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
                <div>
                    <div class="mt-2 text-center">
                        <h3 class="text-lg font-medium leading-6 text-gray-800 capitalize dark:text-white" id="modal-title">Upload Image for cards</h3>
                            {{-- <input type="text" hidden name="userid" value="{{auth()->user()->id}}">
                            <input type="file" name="cardimages[]" id="multipleimage"
                            ...
                            <select name="cardimgs" class="chosen-select" id="cardimgs" multiple>
                ...
                <div class="mt-5 sm:flex sm:items-center sm:justify-between">
                    ...
                    <div class="sm:flex sm:items-center ">
                        ...
                        <button @click="open = false" type="button" class="w-full px-4 py-2 mt-2 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-crimson rounded-md sm:w-auto sm:mt-0 hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40" id="addcontentblock-2">
                            OK
                        </button>
