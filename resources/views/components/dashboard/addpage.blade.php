...
<div x-data="{ isOpen: false }" class="relative flex justify-center">
    ...
    <button @click="isOpen = true" class="w-full px-6 py-2 mx-auto tracking-wide text-darkgreen capitalize transition-colors duration-300 transform bg-beige rounded-md hover:bg-darkbeige">Add page</button>                
    <div x-show="isOpen" 
            ...
            <div class="relative inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl rtl:text-right dark:bg-gray-900 sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
                <div>
                    ...
                    <div class="mt-2 text-center">
                        <h3 class="text-lg font-medium leading-6 text-gray-800 capitalize dark:text-white" id="modal-title">Insert New Page</h3>
                        <input placeholder="Name of page" id="pagename" class="mt-2 text-sm text-gray-500 dark:text-gray-400 rounded">
