<div x-data="{ open: false }">
    <button @click="open = !open" id="footermodal" class="w-full h-full px-6 py-2 mx-auto tracking-wide text-darkgreen capitalize transition-colors duration-300 transform bg-beige hover:bg-darkbeige"><x-polaris-major-buy-button class="w-6 h-6 mx-auto" />Add Footer</button>
    <button @click="open = !open" id="openaddfooter" class="hidden w-full px-6 py-2 mx-auto tracking-wide text-white capitalize transition-colors duration-300 transform bg-red-600 rounded-md hover:bg-red-200 focus:outline-none focus:ring focus:ring-red-300 focus:ring-opacity-80">\</button>
            ...
            <div class="relative inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl rtl:text-right dark:bg-gray-900 sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
                <div>
                    ...
                    <div class="mt-2 flex flex-col w-40 ml-20 pl-3 text-center">
                        <label for="footer" class="text-black">Choose footer</label>
                        <select name="footer" class="" id="footer">
                ...
                <div class="mt-5 sm:flex sm:items-center sm:justify-between">
                    ...
                    <div class="sm:flex sm:items-center ">
                        ...
                        <button @click="open = false" class="w-full px-4 py-2 mt-2 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-md sm:w-auto sm:mt-0 hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40" id="addfooter">
                            OK
                        </button>
                    </div>
                </div>
